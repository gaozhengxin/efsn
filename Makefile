...
miningpool:
	build/env.sh go run build/ci.go install ./cmd/fsn_mining_pool/miningpool_main.go ./cmd/fsn_mining_pool/minerpool.go ./cmd/fsn_mining_pool/fundpool.go ./cmd/fsn_mining_pool/asset.go ./cmd/fsn_mining_pool/mongo.go ./cmd/fsn_mining_pool/utils.go ./cmd/fsn_mining_pool/withdraw.go
